...
export function AppSidebar({ isMobileMenuOpen, setIsMobileMenuOpen }: AppSidebarProps) {
  ...
  return (
    ...
    <div className={`flex md:relative fixed top-0 bottom-0 left-0 z-50 transition-transform duration-300 ease-in-out
      ...
      >
        ...
        <SidebarFooter className="p-2 border-t border-gray-200">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <Avatar className="h-11 w-11 cursor-pointer rounded-full object-cover" onClick={() => setIsUserEditOpen(true)}>
